            ...
            promise.then(function (response) {
                switch (response.status) {
                    case -1:
                        ...
                        break;
                    //case  1: location.href = '/advertisement/' + response.type.slug + '/' + response.id; break;
                    case  1: $location.path('/advertisement/' + response.object.type.slug + '/' + response.object.id); break;
                    case  2:
