(function (angular) {
    ...
    foundController.$inject = ['$scope', '$http', '$routeParams', '$sce', '$rootScope', 'settingsService', 'spinner'];

    function foundController ($scope, $http, $routeParams, $sce, $rootScope, settings, spinner) {
        var self = this;
